import{av as p,p as h,q as a,U as i,W as n,aM as o,Q as r,af as l,m as k}from"./chunks/framework.Bw_R9Ag3.js";const x=JSON.parse('{"title":"介绍","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/readme.md","filePath":"hooks/readme.md"}'),d={name:"hooks/readme.md"},g={href:"https://github.com/shikijs/shiki",class:"vp-link",target:"_blank",rel:"noreferrer"},E={href:"https://vitepress.dev/guide/markdown",class:"vp-link",target:"_blank",rel:"noreferrer"};function c(u,s,m,y,b,v){const t=l("i-ri-external-link-line"),e=l("CoreButton");return k(),h("div",null,[s[7]||(s[7]=a("h1",{id:"介绍",tabindex:"-1"},[i("介绍 "),a("a",{class:"header-anchor vp-link",href:"#介绍","aria-label":'Permalink to "介绍"'},"​")],-1)),s[8]||(s[8]=a("p",null,"This page demonstrates some of the built-in markdown extensions provided by VitePress.",-1)),s[9]||(s[9]=a("h2",{id:"syntax-highlighting",tabindex:"-1"},[i("Syntax Highlighting "),a("a",{class:"header-anchor vp-link",href:"#syntax-highlighting","aria-label":'Permalink to "Syntax Highlighting"'},"​")],-1)),a("p",null,[s[1]||(s[1]=i("VitePress provides Syntax Highlighting powered by ")),a("a",g,[s[0]||(s[0]=i("Shiki")),n(t,{class:"link-icon"})]),s[2]||(s[2]=i(", with additional features like line-highlighting:"))]),s[10]||(s[10]=o(`<p><strong>Input</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>\`\`\`js{4}</span></span>
