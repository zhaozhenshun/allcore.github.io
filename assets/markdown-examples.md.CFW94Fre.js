import{av as p,p as o,q as a,U as n,W as i,aM as r,Q as h,af as t,m as k}from"./chunks/framework.DWZoJ-kx.js";const f=JSON.parse('{"title":"Markdown Extension Examples","description":"","frontmatter":{},"headers":[],"relativePath":"markdown-examples.md","filePath":"markdown-examples.md"}'),d={name:"markdown-examples.md"},E={href:"https://github.com/shikijs/shiki",class:"vp-link",target:"_blank",rel:"noreferrer"},g={href:"https://vitepress.dev/guide/markdown",class:"vp-link",target:"_blank",rel:"noreferrer"};function c(m,s,u,y,b,x){const l=t("i-ri-external-link-line"),e=t("CoreButton");return k(),o("div",null,[s[7]||(s[7]=a("h1",{id:"markdown-extension-examples",tabindex:"-1"},[n("Markdown Extension Examples "),a("a",{class:"header-anchor vp-link",href:"#markdown-extension-examples","aria-label":'Permalink to "Markdown Extension Examples"'},"​")],-1)),s[8]||(s[8]=a("p",null,"This page demonstrates some of the built-in markdown extensions provided by VitePress.",-1)),s[9]||(s[9]=a("h2",{id:"syntax-highlighting",tabindex:"-1"},[n("Syntax Highlighting "),a("a",{class:"header-anchor vp-link",href:"#syntax-highlighting","aria-label":'Permalink to "Syntax Highlighting"'},"​")],-1)),a("p",null,[s[1]||(s[1]=n("VitePress provides Syntax Highlighting powered by ")),a("a",E,[s[0]||(s[0]=n("Shiki")),i(l,{class:"link-icon"})]),s[2]||(s[2]=n(", with additional features like line-highlighting:"))]),s[10]||(s[10]=r(`<p><strong>Input</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>\`\`\`js{4}</span></span>
